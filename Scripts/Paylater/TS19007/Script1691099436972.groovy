...
Mobile.tap(findTestObject('Transaksi PPOB/android.widget.PilihRekening'), 0)

Mobile.tap(findTestObject('Transaksi PPOB/Pulsa/android.widget.TextView - Paylater'), 0)
