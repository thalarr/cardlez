...
Mobile.setText(findTestObject('Object Repository/KYC1/android.widget.EditText (1)'), 'Imam Hermawan', 0)
...
Mobile.setText(findTestObject('KYC1/android.widget.AutoCompleteTextView - Ketik Nama Bank'), 'BCA', 0)
